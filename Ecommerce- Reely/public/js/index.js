function addtocart(pid, pname, price, productImg){
...
function updateCart(){
    ...
    if(cart==null || cart.length == 0){
        ...
        $('.cart-items').html(`<h1 style="margin-top:5rem;padding:0.5rem; display:flex;justify-content:center;align-items:center; background-color:white;color:black">Your cart is empty</h1>
                               <a href="/dashboard" style="text-decoration:none;margin-left:0.5rem"><button style="border:none;background-color:red; border-radius:10px; padding:0.5rem;color:white; width:50%">Start Shopping</button></a>`)
        $('.total-price').html(`
